export const HOUSE_META = {
  tracer: {
    ...
    desc: "Tracer - Evidence Tracker leaves no clue unexamined...",
    heroBg: "#0d0e2e",
  },
  noir: {
    name: "Noir",
  ...
  foxlock: {
    ...
    desc: "Foxlock - Sly Messenger thrives where logic meets mystery...",
    heroBg: "#2a0f0d",
  },
  cipher: {
    name: "Cipher",
    ...
    desc: "Cipher - Clue Analyst moves through the margins...",
    heroBg: "#261540",
  },
} as const;
